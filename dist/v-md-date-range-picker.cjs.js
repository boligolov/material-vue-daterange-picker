...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-2d033558_0", { source: "table.calendar-table[data-v-2d033558]{width:100%;margin:0;border-spacing:0;border-collapse:collapse}table.calendar-table td[data-v-2d033558],table.calendar-table th[data-v-2d033558],table.calendar-table tr[data-v-2d033558]{border:none}table.calendar-table td[data-v-2d033558],table.calendar-table th[data-v-2d033558]{white-space:nowrap;text-align:center;vertical-align:middle;min-width:34px;width:34px;padding:17px 0;height:0;line-height:0;font-size:12px;white-space:nowrap;cursor:pointer}table.calendar-table td.calendar-cell[data-v-2d033558]{position:relative}table.calendar-table td.calendar-cell[data-v-2d033558]:hover{background-color:#eee;border-color:transparent;color:inherit}table.calendar-table td.calendar-cell.today[data-v-2d033558]{font-weight:700}table.calendar-table td.calendar-cell.in-range[data-v-2d033558]{background-color:#eef4ff;border-color:transparent;color:#000;border-radius:0}table.calendar-table td.calendar-cell.active[data-v-2d033558],table.calendar-table td.calendar-cell.active[data-v-2d033558]:hover{border-color:transparent;color:#fff}table.calendar-table td.calendar-cell.active.start-date[data-v-2d033558],table.calendar-table td.calendar-cell.active:hover.start-date[data-v-2d033558]{border-top-left-radius:34px;border-bottom-left-radius:34px}table.calendar-table td.calendar-cell.active.end-date[data-v-2d033558],table.calendar-table td.calendar-cell.active:hover.end-date[data-v-2d033558]{border-top-right-radius:34px;border-bottom-right-radius:34px}table.calendar-table td.calendar-cell.active .calendar-cell__content[data-v-2d033558],table.calendar-table td.calendar-cell.active:hover .calendar-cell__content[data-v-2d033558]{position:absolute;top:5%;left:5%;display:flex;align-items:center;justify-content:center;box-sizing:border-box;width:90%;height:90%;line-height:1;border-radius:999px;background-color:#4285f4}table.calendar-table td.calendar-cell.off[data-v-2d033558],table.calendar-table td.calendar-cell.off.end-date[data-v-2d033558],table.calendar-table td.calendar-cell.off.in-range[data-v-2d033558],table.calendar-table td.calendar-cell.off.start-date[data-v-2d033558]{background-color:#fff;border-color:transparent;color:#999}table.calendar-table td.calendar-cell.off .calendar-cell__content[data-v-2d033558],table.calendar-table td.calendar-cell.off.end-date .calendar-cell__content[data-v-2d033558],table.calendar-table td.calendar-cell.off.in-range .calendar-cell__content[data-v-2d033558],table.calendar-table td.calendar-cell.off.start-date .calendar-cell__content[data-v-2d033558]{background-color:#fff}.v-drp__css-icon-wrapper[data-v-2d033558]{position:relative}.v-drp__css-icon-wrapper .v-drp__css-icon.arrow-left[data-v-2d033558]:before{content:'';position:absolute;left:50%;top:8px;width:7px;height:7px;border-top:solid 2px currentColor;border-right:solid 2px currentColor;transform:rotate(-135deg)}.v-drp__css-icon-wrapper .v-drp__css-icon.arrow-right[data-v-2d033558]:before{content:'';position:absolute;right:50%;top:8px;width:7px;height:7px;border-top:solid 2px currentColor;border-right:solid 2px currentColor;transform:rotate(45deg)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-2d033558";
  /* module identifier */
...
var __vue_staticRenderFns__$1 = [];
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-c17ec1aa_0", { source: ".action-buttons[data-v-c17ec1aa]{clear:both;padding:8px;line-height:12px;vertical-align:middle}.ranges[data-v-c17ec1aa]{font-size:12px;float:none;margin-top:8px;text-align:left}.ranges ul[data-v-c17ec1aa]{list-style:none;margin:0 auto;padding:0;width:100%}.ranges li[data-v-c17ec1aa]{box-sizing:border-box;font-size:12px;padding:8px 12px;cursor:pointer}.ranges li[data-v-c17ec1aa]:hover{background-color:#eee}.ranges li.active[data-v-c17ec1aa]{color:#4285f4}@media (min-width:564px){.ranges ul[data-v-c17ec1aa]{width:140px}}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-c17ec1aa";
  /* module identifier */
...
/* template */
var __vue_render__$3 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"clickoutside",rawName:"v-clickoutside",value:(_vm.clickOutside),expression:"clickOutside"}],staticClass:"mdrp-root"},[_c('div',{staticClass:"mdrp__activator",on:{"click":_vm.togglePicker}},[_vm._t("input",[_c('default-activator',{ref:"defaultActivator",attrs:{"value":(_vm.startText + " - " + _vm.endText),"readonly":""}})])],2),_vm._v(" "),_c('transition',{attrs:{"name":"slide-fade","mode":"out-in"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.pickerVisible),expression:"pickerVisible"}],staticClass:"mdrp__panel dropdown-menu",class:_vm.pickerStyles()},[(_vm.showPresets && _vm.presets)?_c('calendar-ranges',{attrs:{"canSelect":_vm.inRange,"presets":_vm.presets,"applyLabel":_vm.locale.applyLabel,"cancelLabel":_vm.locale.cancelLabel},on:{"clickCancel":function($event){_vm.pickerVisible = false;},"clickApply":_vm.clickApply,"clickPreset":_vm.clickPreset}}):_vm._e(),_vm._v(" "),_c('calendar',{staticClass:"calendar left",attrs:{"location":"left","calendar-month":_vm.leftCalendarMonth_,"locale":_vm.locale,"start":_vm.start_,"end":_vm.end_,"min":_vm.min_,"max":_vm.max_,"hover-start":_vm.hoverStart_,"hover-end":_vm.hoverEnd_},on:{"clickNextMonth":_vm.clickNextMonth,"clickPrevMonth":_vm.clickPrevMonth,"dateClick":_vm.dateClick,"hoverDate":_vm.hoverDate,"clickYearSelect":_vm.clickYearSelect}}),_vm._v(" "),_c('calendar',{staticClass:"calendar right",attrs:{"location":"right","calendar-month":_vm.rightCalendarMonth_,"locale":_vm.locale,"start":_vm.start_,"end":_vm.end_,"min":_vm.min_,"max":_vm.max_,"hover-start":_vm.hoverStart_,"hover-end":_vm.hoverEnd_},on:{"clickNextMonth":_vm.clickNextMonth,"clickPrevMonth":_vm.clickPrevMonth,"dateClick":_vm.dateClick,"hoverDate":_vm.hoverDate,"clickYearSelect":_vm.clickYearSelect}})],1)])],1)};
